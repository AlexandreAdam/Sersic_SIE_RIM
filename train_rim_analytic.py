...
from carrim.models import ModelAnalytic
...
if __name__ == "__main__":
    ...
    parser.add_argument("--units",                  default=13,    type=int)
    ...
    # Optimization params
    parser.add_argument("-e", "--epochs",           default=20,     type=int,       help="Number of epochs for training.")
